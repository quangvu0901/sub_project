        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-white navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('user.index') }}" class="nav-item nav-link active"><i class="fa fa-user me-2"></i>User</a>
                    ...
                    <a href="{{ route('product.index') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Products</a>
                    <a href="{{ route('category.index') }}" class="nav-item nav-link"><i class="fa fa-store me-2"></i>Categories</a>
